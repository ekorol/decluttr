    ...
    <footer role="contentinfo" className="bg-[#1A2A3A] py-10 px-6">
      <div className="max-w-5xl mx-auto flex flex-col items-center gap-4 text-sm text-gray-400">
        <p className="text-xs text-gray-500 tracking-wide uppercase">
          Open source &middot; MIT licensed &middot; Made by{" "}
          <a href={CREATOR_TWITTER_URL} target="_blank" rel="noopener noreferrer" className="hover:text-gray-300 transition-colors normal-case">@tofiakoury</a>
        </p>
        <div className="w-full flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <nav aria-label="Footer" className="flex items-center gap-5 flex-wrap justify-center">
            ...
            <a href={TWITTER_URL} target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">Twitter</a>
            <a href={CHANGELOG_URL} target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">Changelog</a>
